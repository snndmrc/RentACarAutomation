...
yetki VARCHAR(8)
	CONSTRAINT ck_yetki
		CHECK(yetki in('ADMIN','DANISMAN','MUDUR'))
)
...
INSERT tblCalisan VALUES(33079394558,'Sinan','Demirci','Konya',5377063947,'sd@gmail.com')
INSERT tblKullanici VALUES(1,'Sinan1234','Sinan1234','ADMIN')
